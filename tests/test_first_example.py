...
articles_data = {
    ...
    "Bourne 2003": (
        ...
        202.98869187659378,
        [(0, 2.4832559215387606),
         (1001, -0.24935142487144815),
         (2000, 2.588804496667313),
         (-1, np.nan)],
    ),
    "Chu et al. 2012": (
        96,
    ...
    "Kolz et al. 2020": (
        ...
        ["1", "2", "3"],
        20020.585716495105,
        [(0, -2.5685520015275887),
         (1001, 1.014615081297844),
         (40001, -1.3503417465344325),
         (-1, 2.2967864636674706)],
    ),
    "Kozono et al. 2017": (
        30,
        ["internal-external rotation 0 degree-abducted"],
    ...
    "Lawrence et al. 2014": (
        ...
        ["1", "2", "3"],
        114.76964130026826,
        [(0, 1.9527515541902896),
         (1, 2.927958598494005),
         (2, -1.5148684762422286),
         (-1, 3.0088514248714473)],
    ),
