...
def isb_legend_rotation(joint_type: JointType) -> (str,str,str):
    joint_mapping = {
        ...
        JointType.SCAPULO_THORACIC: ("protraction(+)-retraction(-)", "medial(+)-lateral(-) rotation", "posterior(+)-anterior(-) tilt"),
        JointType.ACROMIO_CLAVICULAR: ("protraction(+)-retraction(-)", "medial(+)-lateral(-) rotation", "posterior(+)-anterior(-) tilt"),
        JointType.STERNO_CLAVICULAR: ("protraction(+)-retraction(-)", "depression(+)-elevation(-)", "backwards(+)-forward(-) rotation"),
...
def isb_legend_translation(joint_type: JointType) -> (str,str,str):
    ...
    joint_mapping = {
        ...
        JointType.SCAPULO_THORACIC: ("upward_downward_rotation", "anterior_posterior_tilt", "internal_external_rotation"),
        JointType.ACROMIO_CLAVICULAR: ("anterior_posterior_tilt", "internal_external_rotation", "upward_downward_rotation"),
        JointType.STERNO_CLAVICULAR: ("anterior_posterior_tilt", "internal_external_rotation", "upward_downward_rotation"),
